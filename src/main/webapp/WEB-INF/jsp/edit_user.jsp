...
<html>
	...
	<body>
		...
		<c:url var="formAction" value="/update-user" />
			...
			<fieldset>
				...
				<p>
					...
					<c:if test="${user.gender==1}">
						<form:radiobutton path="gender" value="1" id="male" checked="checked" /><label for="male">Male</label>
					...
					<c:if test="${user.gender!=1}">
						...
						<form:radiobutton path="gender" value="0" id="female" checked="checked" /><label for="female">Female</label>
					</c:if>
				</p>
				<p>
				...
				<p id="buttons">
					...
					<input type="submit" type="submit" value="Update User">
				</p>
			</fieldset>
		</form:form>
	</body>
